...
func TestAPIResponseSchemaCoversGoJSONFields(t *testing.T) {
	...
	assertStructMatchesSchema(t, reflect.TypeOf(RegistrationField{}), schema, "RegistrationField")
	...
	assertStructMatchesSchema(t, reflect.TypeOf(DNSResolverInfo{}), schema, "DNSResolverInfo")
	...
	assertStructMatchesSchema(t, reflect.TypeOf(AITrace{}), schema, "AITrace")
